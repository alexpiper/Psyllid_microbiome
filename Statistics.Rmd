...
test2 <- speedyseq::tax_glom(ps, taxrank="genus")  %>%
  speedyseq::psmelt() %>%
  filter(SampleID =="145_S118")
```
...
#
# run paco
paco_run <- PACo(D, nperm=9, seed=909, method='quasiswap', symmetric=FALSE) #Symetric - is one meant to track the evolution of another?

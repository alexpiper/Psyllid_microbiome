...
NULL
#' Install BBDUK Tool
#' @description Install the BBduk Tool. To be used only on Unix system.
#' @param url url to download the latest version. 
#' @param destdir destination directory to install the tool.
#' @export
